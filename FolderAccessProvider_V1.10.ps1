#
# Folder Access Provider_V1.9.ps1
#
#==============================================================================================
...
$txtboxFolderAccessOutput.text =  
            ...
            $textBlock.text = $txtReqNo.text + "-Folder-" + $txtFolderPath.Text + "-"+ $Global:AccessType +" - access is granted to -" + $txtUserNames +"- through -" + $GroupName
