...
##P8HPCZWEGmaZ7/K1
##L8/UAdDXTlaDjofG5iZk2VP5D2kvY8yV9KasnL2Y+vnnryrJdaIjeWZcowTAJ0SzT/cAQfARiPU6FSolPflLzaDUHvWWUqsemqNbbumLsrdpM1PU5tPY3B6B8LvJEA1uGFnnacI=
##Kc/BRM3KXhU=
##
##
...
Get-ChildItem $Path -Recurse -ErrorAction SilentlyContinue| Where-Object { $_.LastWriteTime -lt $DatetoDelete -and -not $_.psiscontainer }| select -ExpandProperty fullname | Format-List | Out-file $FinalDeleteFileListLocation

Get-ChildItem $Path -Recurse -ErrorAction SilentlyContinue | Where-Object { $_.LastWriteTime -lt $DatetoDelete -and -not $_.psiscontainer} | Remove-Item -Force -Confirm:$false -ErrorAction SilentlyContinue 
