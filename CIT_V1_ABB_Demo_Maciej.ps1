...
<Window
    ...
    Title="CWPS Integration TOOL (CIT) - V1" FontWeight="Bold" Height="800" Width="900" WindowStartupLocation="CenterScreen" ResizeMode="CanMinimize">
...
Start-Process \\XE-S-JUMP005.xe.abb.com\D$\CIT_Demo$\EXE\ACLFinder.exe -Verb runAs
...
Start-Process \\XE-S-JUMP005.xe.abb.com\D$\CIT_Demo$\EXE\HomeDriveFinder.exe -Verb runAs
...
Start-Process \\XE-S-JUMP005.xe.abb.com\D$\CIT_Demo$\EXE\HomeDriveCreator.exe -Verb runAs
...
Start-Process \\XE-S-JUMP005.xe.abb.com\D$\CIT_Demo$\EXE\OffBoarding.exe -Verb runAs
...
Start-Process \\XE-S-JUMP005.xe.abb.com\D$\CIT_Demo$\EXE\LocalAdminRightsProvider.exe -Verb runAs
...
Start-Process \\XE-S-JUMP005.xe.abb.com\D$\CIT_Demo$\EXE\CreateSharedFolder.exe -Verb runAs
...
Start-Process \\XE-S-JUMP005.xe.abb.com\D$\CIT_Demo$\EXE\FolderAccessProvider.exe -Verb runAs
...
Start-Process \\XE-S-JUMP005.xe.abb.com\D$\CIT_Demo$\EXE\GroupMemberAdder.exe -Verb runAs
...
Start-Process \\XE-S-JUMP005.xe.abb.com\D$\CIT_Demo$\EXE\FolderAccessLinkerToGroup.exe -Verb runAs
...
Start-Process \\XE-S-JUMP005.xe.abb.com\D$\CIT_Demo$\EXE\GetADGroupMembers.exe -Verb runAs
...
Start-Process \\XE-S-JUMP005.xe.abb.com\D$\CIT_Demo$\EXE\FolderAccessRemover.exe -Verb runAs
...
Start-Process \\XE-S-JUMP005.xe.abb.com\D$\CIT_Demo$\EXE\BulkProcess.exe -Verb runAs
