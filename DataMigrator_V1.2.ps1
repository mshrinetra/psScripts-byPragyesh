...
if ( ($txtSourceFolderPath.text.Length) -eq 0 -Or ($txtDestinationFolderPath.text.Length) -eq 0 -Or ($txtRequestNo.text.Length) -eq 0)

{


[System.Windows.MessageBox]::Show("Source Folder Path or Destination Folder Path or Task number is empty" ,"Error" )
