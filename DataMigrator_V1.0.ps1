...
<Window
    ...
    <TextBox Name="txtboxMigration" HorizontalAlignment="Left" TextWrapping="Wrap" Text="" VerticalAlignment="Top" Height="350" Width="750" Canvas.Left="100" Canvas.Top="113" Background="{DynamicResource {x:Static SystemColors.ControlLightLightBrushKey}}"/>
...
if ( ($txtSourceFolderPath.text.Length) -eq 0 -Or ($txtDestinationFolderPath.text.Length) -eq 0 )

{


[System.Windows.MessageBox]::Show("Source Folder Path or Destination Folder Path is empty" ,"Error" )
...
$txtboxMigration.text = " Data Migration is completed. Source is " + $tempSourceFolderPath + " Destination is " + $tempDestinationFolderPath +
                         +"  "+
