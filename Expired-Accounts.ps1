...
Search-ADAccount -AccountExpired | select SamAccountName,AccountExpirationdate | Out-GridView -Title "LIST OF EXPIRED ACCOUNTS" -PassThru | out-file "$LogFileName" -Append
