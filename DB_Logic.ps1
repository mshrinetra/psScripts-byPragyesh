...

{
 ...
 $textBlock.text = "-Home folder does not exist. All -" + $ActionPerformed  + " users are using OneDrive."



 CITDatabase -TaskNumber $TaskNumber -ProcessedBy $env:username -ActionPerformed "Submit" -Details $textBlock.text