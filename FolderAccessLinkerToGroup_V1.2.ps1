#
# FolderAccessLinkerToGroup_V1.0.ps1
#
#==============================================================================================
...
<Window
    ...
    Title="Link Folder Access Rights To Group" Height="800" Width="900" WindowStartupLocation="CenterScreen" ResizeMode="CanMinimize">
    <Grid Margin="0,0,-0.2,0.2">
   
    <Border>
   

      <Canvas Background="#FF69B4">
     ...
     <TextBox Name="txtFolderPath" HorizontalAlignment="Left" Height="23" TextWrapping="Wrap" Text="" VerticalAlignment="Top" Width="600" Canvas.Left="250" Canvas.Top="18"/>
             ...
             <StackPanel  Margin="15" Canvas.Left="250" Canvas.Top="40">
                ...
                <RadioButton Name="RadioName4" GroupName="Access">Read Only</RadioButton>
                <RadioButton Name="RadioName5" GroupName="Access">List Only</RadioButton>
         ...
         <TextBox Name="txtGroupName" HorizontalAlignment="Left" Height="23" TextWrapping="Wrap" Text="" VerticalAlignment="Top" Width="300" Canvas.Left="250" Canvas.Top="170"/>

         <Label FontWeight="Bold" Content="Group Name" Canvas.Left="17" Canvas.Top="170"/>
...
{ 
    ...
    ( 
        ...
        [Alias('LogPath')] 
        [string]$Path='C:\Logs\FolderLinkerToGroup.log', 

        [Parameter(Mandatory=$false)] 
        [Alias('LogPath2')] 
        [string]$Path2='\\10.16.99.13\D$\CWPS_Automation\Logs\FolderLinkerToGroup.log', 
...
if($RadioName4.IsChecked)
{

            $Acl = Get-Acl $FolderPath
                                    
            $Ar = New-Object  system.security.accesscontrol.filesystemaccessrule( $Group,"Read",'ContainerInherit,ObjectInherit', 'None', 'Allow')
            $Acl.SetAccessRule($Ar)
            Set-Acl $FolderPath $Acl -ErrorAction Stop
...
if($RadioName5.IsChecked)
{

            $Acl = Get-Acl $FolderPath
                                    
            $Ar = New-Object  system.security.accesscontrol.filesystemaccessrule( $Group,"ListDirectory",'ContainerInherit,ObjectInherit', 'None', 'Allow')
            $Acl.SetAccessRule($Ar)
            Set-Acl $FolderPath $Acl -ErrorAction Stop
