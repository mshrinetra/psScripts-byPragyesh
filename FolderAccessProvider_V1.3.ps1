...
<Window
    ...
    Title="Folder Access Provider" Height="950" Width="900" WindowStartupLocation="CenterScreen" ResizeMode="CanMinimize">
    ...
    <Border>
     ...
     <TextBox Name="txtFolderPath" HorizontalAlignment="Left" Height="23" TextWrapping="Wrap" Text="" VerticalAlignment="Top" Width="700" Canvas.Left="150" Canvas.Top="18"/>
         ...
         <TextBox Name="txtUserName" HorizontalAlignment="Left" Height="23" TextWrapping="Wrap" Text="" VerticalAlignment="Top" Width="300" Canvas.Left="150" Canvas.Top="400"/>
        ...
        <TextBox Name="txtReqNo" HorizontalAlignment="Left" Height="23" TextWrapping="Wrap" Text="" VerticalAlignment="Top" Width="150" Canvas.Left="150" Canvas.Top="435"/>
         ...
         <Label FontWeight="Bold" Content="Task/Request Number" Canvas.Left="17" Canvas.Top="430"/>
           ...
           <StackPanel  Margin="15" Canvas.Left="600" Canvas.Top="350">
...
if ( ($txtGroupName.text.Length) -eq 0 -Or ($txtUserName.text.Length) -eq 0 )

{


[System.Windows.MessageBox]::Show("Group Name or User Email is empty" ,"Error" )
...
$txtboxFolderAccessOutput.text =  
            ...
            $textBlock.text = $txtReqNo.text + "-Folder-" + $txtFolderPath.Text + " access is granted to -" + $User
