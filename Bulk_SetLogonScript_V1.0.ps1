...
$ACLDetails = Get-ADUser -Server "Europe.abb.com" -Filter { Name -eq $TempServer} -ErrorAction Stop |  Set-ADUser –scriptPath “DE\COMMON.BAT DE-S-0183726 $DEG192804-OPEX-IMS_APR_I DE-S-0183727 DEATG DEFRA-S-029056"
