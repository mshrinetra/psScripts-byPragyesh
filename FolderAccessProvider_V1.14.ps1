...
<Window
    ...
    <Border>
     ...
     <TextBox Name="txtFolderPath" HorizontalAlignment="Left" Height="23" TextWrapping="Wrap" Text=""  VerticalAlignment="Top" Width="600" Canvas.Left="150" Canvas.Top="18"/>
            ...
            <TextBox Name="txtboxFolderPathOutput" HorizontalAlignment="Left" TextWrapping="Wrap" Text="" ScrollViewer.VerticalScrollBarVisibility="Auto" ScrollViewer.HorizontalScrollBarVisibility="Auto" VerticalAlignment="Top" Height="235" Width="700" Canvas.Left="150" Canvas.Top="50" Background="{DynamicResource {x:Static SystemColors.ControlLightLightBrushKey}}"/>
        ...
        <TextBox Name="txtReqNo" HorizontalAlignment="Left" Height="23" TextWrapping="Wrap" Text="" VerticalAlignment="Top" Width="150" Canvas.Left="150" Canvas.Top="435"/>
         ...
         <Label FontWeight="Bold" Content="TASK Number" Canvas.Left="17" Canvas.Top="430"/>
           ...
           <StackPanel  Margin="15" Canvas.Left="750" Canvas.Top="350">
             ...
             <TextBox Name="txtboxFolderAccessOutput" HorizontalAlignment="Left" TextWrapping="Wrap" Text="" ScrollViewer.VerticalScrollBarVisibility="Auto" ScrollViewer.HorizontalScrollBarVisibility="Auto"  VerticalAlignment="Top" Height="250" Width="700" Canvas.Left="150" Canvas.Top="475" Background="{DynamicResource {x:Static SystemColors.ControlLightLightBrushKey}}"/>
    ...
    <Button Name="btnOpenFolder" Content="Open" IsEnabled="true" HorizontalAlignment="Left" Margin="775,18,0,0" VerticalAlignment="Top" Width="100" Height="23" BorderThickness="0"/>
      ...
      <Button Name="btnSearchACL" Content="Search ACL" IsEnabled="true" HorizontalAlignment="Left" Margin="0,310,0,0" VerticalAlignment="Top" Width="900" Height="34" BorderThickness="0"/>
...
{ 
    ...
    ( 
        ...
        [Parameter(Mandatory=$false)] 
        [Alias('LogPath2')] 
        [string]$Path2='\\XE-S-JUMP005.xe.abb.com\E$\CIT_Automation$\Logs\FolderAccessProvider.log', 
...
if ( ($txtGroupName.text.Length) -eq 0 -Or ($txtUserNames.text.Length) -eq 0 -or ($txtReqNo.text.Length) -eq 0 -or  (-not $txtReqNo.text.contains("TASK")) -or ($Global:AccessType -eq $null))

{


[System.Windows.MessageBox]::Show("Group Name or User Email or TASK Number or AccesssType is empty" ,"Error" )
...
if( ($Global:AccessType -eq "Read Only") -and ($GroupName -like "*rw*"))
{


[System.Windows.MessageBox]::Show("Selected group contains RW word however AccessType selection is Read-Only.Please cross verify." ,"Error" )
...
$txtboxFolderAccessOutput.text =  
            ...
            $textBlock.text = ";" +$txtReqNo.text + ";" + $txtFolderPath.Text + ";"+ $Global:AccessType + ";"+ $GroupName + ";--access is granted to--;" + $txtUserNames 
