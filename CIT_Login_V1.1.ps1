...
<Window
    ...
    Title="CWPS Integration Tool(CIT) Automation Tool - Login" FontWeight="Bold" Height="800" Width="900" WindowStartupLocation="CenterScreen" ResizeMode="CanMinimize">
...
{ 
    ...
    ( 
        ...
        [Alias('LogPath')] 
        [string]$Path='C:\Logs\CIT_Login.log', 

        [Parameter(Mandatory=$false)] 
        [Alias('LogPath2')] 
        [string]$Path2='\\10.16.99.13\D$\CWPS_Automation\Logs\CIT_Login.log', 
...

{
 ...
 Get-ADuser $txtUserName.Text -Server "de-s-abb0033.abb.com:3268" -ErrorAction Stop
        ...
        If ($members -contains $user[-1])



        {

        Start-Process \\XE-S-JUMP005.xe.abb.com\E$\CIT_Automation$\EXE\Ind_EXE\IND_CIT.exe -Verb runAs
        Break
        ...
        $group = "U-XW-CWPS-World-CIT Automation Tool"
        $members = Get-ADGroupMember -Identity $group -Recursive | Select -ExpandProperty SAMAccountName 
        ...
        Start-Process \\XE-S-JUMP005.xe.abb.com\E$\CIT_Automation$\EXE\Ind_EXE\World_CIT.exe -Verb runAs
        ...
        $group = "U-XW-CWPS-TEST-CIT Automation Tool"
        $members = Get-ADGroupMember -Identity $group -Recursive | Select -ExpandProperty SAMAccountName 
        ...
        Start-Process \\XE-S-JUMP005.xe.abb.com\E$\CIT_Automation$\EXE\Ind_EXE\TEST_CIT.exe -Verb runAs
        Break
        ...
        Start-Process \\XE-S-JUMP005.xe.abb.com\E$\CIT_Automation$\EXE\Ind_EXE\Specific_CIT.exe -Verb runAs
        ...
        $group = "U-XW-CWPS-DEMO-CIT Automation Tool"
        $members = Get-ADGroupMember -Identity $group -Recursive | Select -ExpandProperty SAMAccountName 
        ...
        Start-Process \\XE-S-JUMP005.xe.abb.com\E$\CIT_Automation$\EXE\Ind_EXE\DEMO_CIT.exe -Verb runAs
