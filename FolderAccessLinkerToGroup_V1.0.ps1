...
<Window
    ...
    <Border>
     ...
     <TextBox Name="txtFolderPath" HorizontalAlignment="Left" Height="23" TextWrapping="Wrap" Text="" VerticalAlignment="Top" Width="600" Canvas.Left="250" Canvas.Top="18"/>
         ...
         <TextBox Name="txtGroupName" HorizontalAlignment="Left" Height="23" TextWrapping="Wrap" Text="" VerticalAlignment="Top" Width="300" Canvas.Left="250" Canvas.Top="150"/>

         <Label FontWeight="Bold" Content="Group Name" Canvas.Left="17" Canvas.Top="150"/>
