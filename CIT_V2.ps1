...
<Window
    ...
    Title="CWPS Integration TOOL (CIT)" FontWeight="Bold" Height="800" Width="900" WindowStartupLocation="CenterScreen" ResizeMode="CanMinimize">
    ...
    <Border>
     ...
     <Button Name="btnHomeDriveCreator" Content="Home Drive Creator" HorizontalAlignment="Left" Margin="0,125,0,0" VerticalAlignment="Top" Width="900" Height="34" BorderThickness="0"/>
       ...
       <Button Name="btnDataMigrator" Content="Data Migrator" HorizontalAlignment="Left" Margin="0,225,0,0" VerticalAlignment="Top" Width="900" Height="34" BorderThickness="0"/>
       ...
       <Button Name="btnGroupMemberAdder" Content="Group Member Adder" HorizontalAlignment="Left" Margin="0,375,0,0" VerticalAlignment="Top" Width="900" Height="34" BorderThickness="0"/>
        ...
        <Button Name="btnGetADGroupMembers" Content="Get AD Group Members" HorizontalAlignment="Left" Margin="0,475,0,0" VerticalAlignment="Top" Width="900" Height="34" BorderThickness="0"/>


         <Button Name="btnFolderAccessRemover" Content="Folder Access Remover" HorizontalAlignment="Left" Margin="0,525,0,0" VerticalAlignment="Top" Width="900" Height="34" BorderThickness="0"/>

        <Button Name="btnBulkProcess" Content="Other/Bulk Process" HorizontalAlignment="Left" Margin="0,575,0,0" VerticalAlignment="Top" Width="900" Height="34" BorderThickness="0"/>
...
Start-Process \\XE-S-JUMP005.xe.abb.com\E$\CIT_Automation$\EXE\Ind_EXE\ACLFinder.exe -Verb runAs
...
Start-Process \\XE-S-JUMP005.xe.abb.com\E$\CIT_Automation$\EXE\Ind_EXE\HomeDriveFinder.exe -Verb runAs
...
Start-Process \\XE-S-JUMP005.xe.abb.com\E$\CIT_Automation$\EXE\Ind_EXE\HomeDriveCreator.exe -Verb runAs
...
Start-Process \\XE-S-JUMP005.xe.abb.com\E$\CIT_Automation$\EXE\Ind_EXE\OffBoarding.exe -Verb runAs
 ...
 $btnDataMigrator.Add_Click({

 


Start-Process \\XE-S-JUMP005.xe.abb.com\E$\CIT_Automation$\EXE\Ind_EXE\DataMigrator.exe -Verb runAs
...
Start-Process \\XE-S-JUMP005.xe.abb.com\E$\CIT_Automation$\EXE\Ind_EXE\CreateSharedFolder.exe -Verb runAs
...
Start-Process \\XE-S-JUMP005.xe.abb.com\E$\CIT_Automation$\EXE\Ind_EXE\FolderAccessProvider.exe -Verb runAs
...
Start-Process \\XE-S-JUMP005.xe.abb.com\E$\CIT_Automation$\EXE\Ind_EXE\GroupMemberAdder.exe -Verb runAs
...
Start-Process \\XE-S-JUMP005.xe.abb.com\E$\CIT_Automation$\EXE\Ind_EXE\FolderAccessLinkerToGroup.exe -Verb runAs



})

$btnGetADGroupMembers.Add_Click(
...
Start-Process \\XE-S-JUMP005.xe.abb.com\E$\CIT_Automation$\EXE\Ind_EXE\GetADGroupMembers.exe -Verb runAs
...
$btnFolderAccessRemover.Add_Click(
...
Start-Process \\XE-S-JUMP005.xe.abb.com\E$\CIT_Automation$\EXE\Ind_EXE\FolderAccessRemover.exe -Verb runAs
...
Start-Process \\XE-S-JUMP005.xe.abb.com\E$\CIT_Automation$\EXE\Ind_EXE\BulkProcess.exe -Verb runAs
